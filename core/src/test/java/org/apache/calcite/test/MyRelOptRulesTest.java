 ...
 * </ol>
 */
public class MyRelOptRulesTest extends RelOptTestBase {
  //~ Methods ----------------------------------------------------------------
  ...
  protected DiffRepository getDiffRepos() {
    return DiffRepository.lookup(MyRelOptRulesTest.class);
  }
  ...
  /** Tests {@link IntersectToDistinctRule},
  ...
  /** Tests that {@link IntersectToDistinctRule}
